...
export const metadata: Metadata = {
  ...
  description:
    "Fire hydrant installation, pressure testing, and certification for commercial and industrial sites across Gauteng, Johannesburg, and Pretoria.",
}
...
const included = [
  {
    ...
    description: "New hydrant installations sized and positioned to meet your site's fire safety requirements.",
  },
  {
    icon: Gauge,
    title: "Pressure Testing",
    description: "Flow and pressure testing to confirm every hydrant performs the way it should in an emergency.",
  },
  {
    icon: FileCheck,
    title: "Certification",
    description: "Test results and certification supplied for your compliance file and insurer.",
  },
  {
    icon: Droplets,
    title: "Ongoing Testing",
    description: "Scheduled retesting to keep hydrants certified and ready throughout the year.",
  },
]

const benefits = [
  "A properly tested hydrant network gives firefighters reliable water pressure when every minute counts",
  "Meets fire safety and building compliance requirements for commercial and industrial sites",
  "Identifies pressure or supply issues before they become a problem during an actual fire",
  "Certification and test records ready for auditors, insurers, and fire department inspections",
]
...
const process = [
  {
    ...
    description: "We map existing hydrants and water supply, and identify where new installations are needed.",
  },
  {
    step: "02",
    title: "Installation Plan",
    description: "A written quote and layout showing hydrant positions, pipework, and expected pressure.",
  },
  {
    step: "03",
    title: "Installation & Testing",
    description: "Hydrants are installed and immediately flow and pressure tested to confirm performance.",
  },
  {
    step: "04",
    title: "Certification",
    description: "Test results are documented and a compliance certificate issued on completion.",
  },
]
...
export default function FireHydrantInstallationTestingPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-primary">
        {/* PLACEHOLDER: swap for a real photo of a Jero Fire Solutions technician installing or testing a hydrant */}
        <div className="absolute inset-0">
          <Image
            src="/fire-hydrant-installation-technician.jpg"
            alt="Jero Fire Solutions technician installing a fire hydrant in Gauteng"
            fill
        ...
        <div className="container relative mx-auto px-4 py-16 lg:px-8 lg:py-24">
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-primary-foreground/70">
            ...
            <span className="mx-2">/</span>
            <span className="text-primary-foreground">Fire Hydrant Installation &amp; Testing</span>
          </nav>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-pretty text-lg text-primary-foreground/80 md:text-xl">
              Hydrant installation, pressure testing, and certification, giving your site a reliable water supply for firefighting when it matters most.
            </p>
      ...
      <section className="bg-muted py-20 lg:py-28">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            {/* PLACEHOLDER: swap for a real photo of a hydrant pressure test or inspection in progress */}
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-border order-2 lg:order-1">
              <Image
                src="/fire-hydrant-pressure-testing-inspection.jpg"
                alt="Fire hydrant pressure testing carried out by Jero Fire Solutions in Gauteng"
                fill
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="mb-6 text-balance text-3xl font-bold tracking-tight md:text-4xl">
                Water Pressure You Can Rely On
              </h2>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="rounded-2xl border-2 border-accent/30 bg-card p-8 lg:p-12 text-center relative overflow-hidden">
            ...
            <h2 className="mb-4 text-2xl font-bold lg:text-3xl">
              Ready to Test Your Hydrants?
            </h2>
            <p className="mb-8 max-w-2xl mx-auto text-muted-foreground">
              Get a free, no obligation quote for hydrant installation, testing, or certification.
            </p>
