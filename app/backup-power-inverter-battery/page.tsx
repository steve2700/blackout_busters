...
export const metadata: Metadata = {
  ...
  description:
    "Scheduled maintenance contracts for extinguishers, alarms, and suppression systems across Gauteng, Johannesburg, and Pretoria, keeping your fire equipment compliant year round.",
}
...
const included = [
  {
    ...
    description: "Regular service visits set to the intervals your equipment and compliance certificates require.",
  },
  {
    icon: Building2,
    title: "Multi Site Contracts",
    description: "One contract covering every branch or building, with a single point of contact.",
  },
  {
    icon: Clock,
    title: "Priority Response",
    description: "Contract clients move to the front of the queue for breakdowns and urgent callouts.",
  },
  {
    icon: FileCheck,
    title: "Compliance Records",
    description: "A full service history and current certificates, ready whenever an auditor asks.",
  },
]

const benefits = [
  "Equipment stays compliant and ready, instead of only being checked after something fails",
  "One contract and one invoice covers every extinguisher, alarm, and suppression system on site",
  "Priority callout response when contract clients need urgent attention",
  "A full digital service history available at any time for audits or insurance claims",
]
...
const process = [
  {
    step: "01",
    title: "Site Survey",
    description: "We list every piece of fire equipment on site and check it against what compliance requires.",
  },
  {
    step: "02",
    title: "Contract Proposal",
    description: "A written contract with service intervals, pricing, and response times, tailored to your site.",
  },
  {
    step: "03",
    title: "Scheduled Visits",
    description: "Our technicians service, test, and tag equipment on the agreed schedule, with no surprises.",
  },
  {
    step: "04",
    title: "Reporting",
    description: "Each visit ends with a report and updated certificates added to your compliance file.",
  },
]
...
export default function FireEquipmentMaintenanceContractsPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-primary">
        {/* PLACEHOLDER: swap for a real photo of a Jero Fire Solutions technician servicing equipment on a maintenance visit */}
        <div className="absolute inset-0">
          <Image
            src="/fire-equipment-maintenance-technician-servicing.jpg"
            alt="Jero Fire Solutions technician on a scheduled maintenance visit in Gauteng"
            fill
        ...
        <div className="container relative mx-auto px-4 py-16 lg:px-8 lg:py-24">
          <nav aria-label="Breadcrumb" className="mb-6 text-sm text-primary-foreground/70">
            ...
            <span className="mx-2">/</span>
            <span className="text-primary-foreground">Fire Equipment Maintenance Contracts</span>
          </nav>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-pretty text-lg text-primary-foreground/80 md:text-xl">
              Scheduled servicing for extinguishers, alarms, and suppression systems, so your fire equipment stays compliant and ready all year, without you having to track every certificate yourself.
            </p>
      ...
      <section className="bg-muted py-20 lg:py-28">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            {/* PLACEHOLDER: swap for a real photo of a technician checking or tagging an extinguisher */}
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl ring-1 ring-border order-2 lg:order-1">
              <Image
                src="/fire-extinguisher-annual-service-check.jpg"
                alt="Fire extinguisher being serviced by Jero Fire Solutions in Gauteng"
                fill
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="mb-6 text-balance text-3xl font-bold tracking-tight md:text-4xl">
                Compliance You Do Not Have to Chase
              </h2>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="rounded-2xl border-2 border-accent/30 bg-card p-8 lg:p-12 text-center relative overflow-hidden">
            ...
            <h2 className="mb-4 text-2xl font-bold lg:text-3xl">
              Ready for a Maintenance Contract?
            </h2>
            <p className="mb-8 max-w-2xl mx-auto text-muted-foreground">
              Get a free, no obligation quote for a maintenance contract covering your fire equipment.
            </p>
