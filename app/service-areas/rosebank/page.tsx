...
export const metadata: Metadata = {
  title: "Construction & Maintenance Services in Rosebank | Goshen Projects",
  description:
...
export default function RosebankPage() {
  return (
    <ServiceAreaTemplate
      areaName="Rosebank"
      description="Goshen Projects serves Rosebank's sophisticated mix of heritage homes, modern apartments, and commercial properties with premium construction and maintenance services tailored to this prestigious area."
      suburbs={["Parktown", "Saxonwold", "Dunkeld", "Forest Town", "Parkhurst", "Greenside", "Westcliff", "Killarney"]}
      introduction="Rosebank represents the heart of Johannesburg's northern suburbs, combining historic properties with contemporary developments. Goshen Projects understands the unique requirements of this area, from sensitive heritage renovations to modern commercial fit-outs. Our expertise ensures that every project respects the character of Rosebank while meeting modern standards."
      servicesOffered={[
