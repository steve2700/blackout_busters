...
export const metadata: Metadata = {
  title: "Construction & Maintenance Services in Centurion | Goshen Projects",
  description:
...
export default function CenturionPage() {
  return (
    <ServiceAreaTemplate
      areaName="Centurion"
      description="Goshen Projects provides trusted construction and maintenance services throughout Centurion. From family homes in established suburbs to modern developments, we deliver quality workmanship for every property type."
      suburbs={[
        "Highveld",
        "Eldoraigne",
        "Irene",
